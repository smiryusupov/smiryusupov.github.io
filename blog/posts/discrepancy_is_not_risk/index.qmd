...
The examples below are deliberately small. They are not arguments against MMD, or in favor of T-rules or D-rules. They isolate places where the objects separate.
...
## Diagnostic 6: Gaussian-looking risk formulas can still be wrong

There is one more place where the same confusion appears. Even after choosing the T-rule or D-rule, one can still use the wrong error formula.
...
If the answer is no, a small discrepancy may be false comfort, and a large discrepancy may be irrelevant alarm.
