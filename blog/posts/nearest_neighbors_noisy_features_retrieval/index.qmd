...
Dense embeddings are not the villain here. They are useful precisely because they organize semantic structure. Retrieval fails when the geometry they impose is misaligned with the feature needed by the query.
...
Across the Gaussian toy model, one-hot tabular data, and retrieval, the same failure appears: closeness stops tracking relevance. Once that happens, the local neighborhood may look plausible while becoming useless for the task.
